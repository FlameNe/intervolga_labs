  ...
  <div :class="$style.root">
    <Table
      :headers="[
        ...
        {value: 'viscosity', text: 'Вязкость'},
        {value: 'volume', text: 'Объем'},
        {value: 'category', text: 'Категория масла'},
...
import { selectItems, removeItem, fetchItems } from '@/store/motors/selectors';
...
export default {
  ...
  setup() {
    ...
    return {
      ...
      onClickEdit: id => {
        router.push({ name: 'MotorEdit', params: { id } })
      }
    }
  }
